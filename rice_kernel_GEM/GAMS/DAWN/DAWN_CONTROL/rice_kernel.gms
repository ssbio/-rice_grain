...
*	reform2(j)				reformulation 2
	...
	chalk5					implementing chalk5 constraint
;
**************************************************************
...
objective..			Z =e= v('Seed_Biomass[K]');
...
*biomass_fix..			v('Seed_Biomass[K]') =e= 1.579;

*reform1(j)..			v(j) =l= D(j);

*reform2(j)..			- v(j) =l= D(j);

oxygen_uptake..			v('Exe2[K]') =e= -28;

chalk5..			v('R00004[K,p]') =e= 0;
...
solve rice_kernel using lp maximizing Z;
********************************************
****************Output File*****************
